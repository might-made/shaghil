...
function lock(value){visualBusy=value;el('visualGenerate').disabled=value;document.querySelectorAll('#visualActions button, #aiActions button').forEach(b=>b.disabled=value)}
